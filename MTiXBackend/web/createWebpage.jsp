                ...
                <div class="col-md-12">
                    <div class="card">  
                        ...
                        <table>
                            ...
                            <textarea class="form-control" name="synopsis" cols="1" rows="7"></textarea>              
                            </tr><br>
                            <tr>
                            <label>Program Details : </label>
                            <textarea class="form-control" name="programDetails" cols="1" rows="7"></textarea>              
                            </tr><br>
                            <tr>
                            <label>Admission Rules : </label>
                            <textarea class="form-control" name="rules" cols="1" rows="7"></textarea>              
                            </tr><br>
                            <tr>
                            <label>Other Details : </label>
                            <textarea class="form-control" name="details" cols="1" rows="7"></textarea>              
